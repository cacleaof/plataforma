		...
		<div class="box-body">
				...
				<form method="POST" action="{{ route('consult.store')}}>
					...
					<div class="form-group">
						<input type="text" name="duvida" placeholder="Descreva sua dúvida ou questionamento" class "form-control">
						<input type="text" name="anexo" placeholder="Inclua aqui seus anexos" class "form-control">
						...
						<input type="text" name="municipio" placeholder="Municipio do paciente" class "form-control">
